...
const HelperSocket = "/var/run/wakeguard-helper.sock"
...
const (
	DaemonLabel = "glass.wakeguard.daemon"
	HelperLabel = "glass.wakeguard.helper"
)

func platformLayout(home string) Layout {
	return Layout{
		StateDir:      filepath.Join(home, "Library", "Application Support", "WakeGuard"),
		LogDir:        filepath.Join(home, "Library", "Logs", "WakeGuard"),
