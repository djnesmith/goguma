...
enum WakeGuardState: Sendable, Hashable {
...
enum ConnectionState: Sendable, Equatable {
    ...
    case connecting
    case connected
    /// The daemon isn't there. This is the "run `wakeguard install`" case.
...
private struct PollingSurfaceModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .onAppear { store.beginObserving(surface) }
            .onDisappear { store.endObserving(surface) }
    }
}
