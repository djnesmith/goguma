...
///
/// WakeGuard is an `LSUIElement`-style accessory app, so SwiftUI's `Scene`
...
final class WindowCoordinator: NSObject, NSWindowDelegate {
    ...
    func windowWillClose(_ notification: Notification) {
        ...
        // WakeGuard doesn't sit in the Dock doing nothing.
