...
//
// Every visual decision in WakeGuard's menu bar app lives here: colours, type,
...
// quiet neutrals. Its stated principles are restraint and honesty. WakeGuard
...
enum Theme {
    ...
    enum Colors {
        ...
        static let accent = adaptive(light: 0x2E6A8F, dark: 0x8FB6D4)
        ...
        static let brandFill = adaptive(light: 0x8FB6D4, dark: 0x8FB6D4)
        ...
        /// Body copy.
        static let textPrimary = adaptive(light: 0x1C2A33, dark: 0xE9EFF3)
        /// Labels, timestamps, explanations.
        static let textSecondary = adaptive(light: 0x5C6B75, dark: 0x8D9CA7)
        ...
        static let surface = adaptive(light: 0xEEF4F8, dark: 0x14191D)
        /// A raised card or panel.
        static let card = adaptive(light: 0xFFFFFF, dark: 0x1D242A)
        ...
        static let divider = adaptive(light: 0xDBE5EC, dark: 0x2A333A)
        ...
        /// WakeGuard is *doing* something, and it used to render in the same
        ...
        /// A job WakeGuard adopted automatically rather than one the user added.
    ...
    enum StatusItem {
        ...
        static func tint(for state: WakeGuardState) -> NSColor {
            switch state {
            case .idle, .holding:
    ...
    enum Surface {
        ...
        static let jobsWindowSize = CGSize(width: 900, height: 500)
